    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      ...
      <div className="bg-white dark:bg-dark-elevated border border-gray-200 dark:border-dark-border-default rounded-lg shadow-sm p-6 mb-8">
        <div className="flex flex-wrap gap-3 mb-6">
          ...
          <div className="text-sm text-gray-500">
            Creado {formatRelativeTime(new Date(createdAt))}
          </div>
          {updatedAt !== createdAt && (
            <div className="text-sm text-gray-500">
              Actualizado {formatRelativeTime(new Date(updatedAt))}
            </div>
          )}
        </div>
        ...
        {description ? (
          ...
          <p className="text-gray-500 italic">No se proporcionó una descripción.</p>
        )}
      </div>
      ...
      <div className="bg-white dark:bg-dark-elevated border border-gray-200 dark:border-dark-border-default rounded-lg shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 mb-1">Creado</p>
